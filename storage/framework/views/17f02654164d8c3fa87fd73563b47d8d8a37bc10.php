                    ...
                    <div class="card-body">
                        <div id="pay-invoice">
                            <div class="card-body">
                                ...
                                <?php endif; ?>
                                <form action="<?php echo e(route('update_password')); ?>" method="post" novalidate="novalidate"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" id="cpwd"
                                               placeholder="<?php echo e(__('messages.Enter Current Password')); ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" id="npwd"
                                               placeholder="<?php echo e(__('messages.Enter New Password')); ?>" class="form-control"
                                               name="npwd" required="">
                                    </div>
                                    <div class="form-group">
                                        <label for="name" class=" form-control-label">
                                        ...
                                        <input type="password" id="rpwd"
                                               placeholder="<?php echo e(__('messages.Re-enter New Password')); ?>"
