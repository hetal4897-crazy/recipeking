...
<?php $__env->startSection('content'); ?>
                        ...
                        <div class="card-body">
                            ...
                            <div style="margin-bottom:10px">
                                <a href="" class="btn btn-primary" data-toggle="modal"
                                   data-target="#add_Category"><?php echo e(__('messages.Add Category')); ?></a>
                            </div>
        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="small_modal_Label"><?php echo e(__('messages.Add Category')); ?></h5>
                    ...
                    <div class="modal-body">
                        <div class="form-row">
                            ...
                            <input type="text" name="name" id="name" class="form-control" required
                                   placeholder="<?php echo e(__('messages.Enter Category Name')); ?>"/>
                        </div>
                        <div class="form-row">
    ...
    <div class="modal fade" id="edit_category" tabindex="-1" role="dialog" aria-labelledby="small_modal_Label"
        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="small_modal_Label"><?php echo e(__('messages.Edit Category')); ?></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="<?php echo e(route('update_category')); ?>" method="post" enctype="multipart/form-data">
                    <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\myproject\recipeking\resources\views/admin/category/default.blade.php ENDPATH**/ ?>