...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('public/admin-design/vendors/datatables.net-bs4/css/dataTables.bootstrap4.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('public/admin-design/vendors/datatables.net-buttons-bs4/css/buttons.bootstrap4.min.css')); ?>">
    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo e(url('dashboard')); ?>"><?php echo e(__('messages.Recipe King')); ?></a>
                <a class="navbar-brand hidden" href="<?php echo e(url('dashboard')); ?>"><?php echo e(__('messages.RK')); ?></a>
            </div>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active">
                        <a href="<?php echo e(url('category')); ?>"> <i class="menu-icon ti-layout-grid2"></i><?php echo e(__('messages.Cateogry')); ?></a>
                    </li>
                    <li class="active">
                        <a href="<?php echo e(url('recipe')); ?>"> <i class="menu-icon ti-book"></i><?php echo e(__('messages.Recipes')); ?></a>
                    </li>
                     <li class="active">
                        <a href="<?php echo e(url('user')); ?>"> <i class="menu-icon ti-user"></i><?php echo e(__('messages.Users')); ?></a>
                    </li>
                    <li class="active">
                        <a href="<?php echo e(url('review')); ?>"> <i class="menu-icon ti-star"></i><?php echo e(__('messages.Reviews')); ?></a>
                    </li>
                    <li class="active">
                        <a href="<?php echo e(url('setting')); ?>"> <i class="menu-icon fa fa-cog"></i><?php echo e(__('messages.Setting')); ?></a>
                    </li>
                ...
                <div class="col-sm-7">
                    ...
                    <div class="header-left">
                        ...
                        <div class="dropdown for-notification">
                            <button class="btn btn-secondary dropdown-toggle" onclick="checknotify()" type="button" id="notification" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="<?php echo e(asset('public/upload/profile/'.Auth::user()->profile_pic)); ?>" alt="User Avatar">
                        </a>

                        <div class="user-menu dropdown-menu">
                            <a class="nav-link" href="<?php echo e(url('editprofile')); ?>"><i class="fa fa-user"></i> <?php echo e(__('messages.My Profile')); ?></a>

                            <a class="nav-link" href="<?php echo e(url('changepassword')); ?>"><i class="fa fa-cog"></i> <?php echo e(__('messages.Change password')); ?></a>
...
<?php /**PATH /home/y31xhhiebz36/public_html/recipeking/resources/views/admin/index.blade.php ENDPATH**/ ?>