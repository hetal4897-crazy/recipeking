...
Route::group(['middleware' => ['admin_check_exist']], function () {
    ...
    Route::post("Save_recipe_step1","RecipeController@Save_recipe_step1")->name("Save_recipe_step1");
    Route::post("Save_recipe_step2","RecipeController@Save_recipe_step2")->name("Save_recipe_step2");
    Route::post("Save_recipe_step3","RecipeController@Save_recipe_step3")->name("Save_recipe_step3");
    Route::post("Save_recipe_step4","RecipeController@Save_recipe_step4")->name("Save_recipe_step4");
