                ...
                <div class="card-body">
                    <div class="stat-widget-one">
                        ...
                        <div class="stat-content dib">
                            ...
                            <div class="stat-digit"><?php echo e($category); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="stat-widget-one">
                        ...
                        <div class="stat-content dib">
                            ...
                            <div class="stat-digit"><?php echo e($recipe); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="stat-widget-one">
                        ...
                        <div class="stat-content dib">
                            ...
                            <div class="stat-digit"><?php echo e($total_user); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="stat-widget-one">
                        ...
                        <div class="stat-content dib">
                            ...
                            <div class="stat-digit"><?php echo e($review); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <h4 class="orderh4">
                            ...
                            <a class="btn btn-primary btn-flat m-b-30 m-t-30 elec textorder"
                               href="<?php echo e(url('recipe')); ?>"><?php echo e(__('messages.Show All')); ?> </a>
                        </h4>
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="orderh4">
                            ...
                            <a class="btn btn-primary btn-flat m-b-30 m-t-30 elec textorder"
                               href="<?php echo e(url('review')); ?>"><?php echo e(__('messages.Show All')); ?> </a>
                        </h4>
                        <div class="table-responsive dtdiv">
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\myproject\recipeking\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>