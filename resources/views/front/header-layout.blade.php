...
@yield('metadata')
		...
		<header class="tstbite-header bg-white">
			<nav class="navbar navbar-expand-lg has-header-inner px-0">
				<a class="navbar-brand" href="index.html">
					<img src="{{asset('public/tastebite/images/brands/brand4.svg')}}" style="max-width: 161px;" alt="Tastebite">
				</a>
				<div class="tstbite-header-links d-flex align-items-center ml-auto order-0 order-lg-2">
					...
					<a href="#0" class="ml-4 ml-md-4 mr-2 mr-md-0 circle">
						<img src="{{asset('public/tastebite/images/avatars/avatar1.png')}}" alt="Avatar">
					</a>
				</div>
				...
				<div class="collapse navbar-collapse" id="menu-4">
					<ul class="navbar-nav m-auto pt-3 pt-lg-0">
						...
						<li class="nav-item">
							<a class="nav-link" href="elements.html">Contact us</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="elements.html">More</a>
						</li>
					</ul>
				</div>
			</nav>
	...
	<script type="text/javascript" src="https://kit.fontawesome.com/e8bbb49528.js"></script>