                     ...
                     <form action="<?php echo e(url('updatesetting')); ?>" method="post" novalidate="novalidate" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          ...
                          <?php echo e(__('messages.Android Server Key')); ?>
                           ...
                           <textarea required id="android_server_key" name="android_server_key"  class="form-control"  placeholder="<?php echo e(__('messages.Android Server Key')); ?>" ><?= isset($setting->android_server_key)?$setting->android_server_key:""?></textarea>
                        ...
                        <div class="form-group">
                          ...
                          <?php echo e(__('messages.Iphone Server Key')); ?>
                           ...
                           <textarea required id="ios_server_key" name="ios_server_key"  class="form-control" value="" placeholder="<?php echo e(__('messages.Iphone Server Key')); ?>"><?= isset($setting->ios_server_key)?$setting->ios_server_key:""?></textarea>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/y31xhhiebz36/public_html/recipeking/resources/views/admin/setting.blade.php ENDPATH**/ ?>