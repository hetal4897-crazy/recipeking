...
<head>
    ...
    <meta property="og:title"         content="<?php echo e(isset($data->name)?$data->name:''); ?>" />
    <meta property="og:description"   content="<?php echo e(isset($data->description)?$data->description:''); ?>" />

				<meta property="og:image" itemprop="image" content="<?php echo e(asset('public/upload/recipe').'/'.$data->image); ?>" />
...
<body>
	<div class="container con">
		...
		<div class="box">
			...
			<div class="text-box">
				<h2><?php echo e(isset($data->name)?$data->name:''); ?></h2>
			...
			<div class="video-a">
				<ul style="list-style: none">
				     ...
				     <li style="float: left;"> <img src="<?php echo e(asset('public/upload/recipe').'/'.$data->image); ?>" style="width: 250px;height: 250px;" /></li>
				...
				<div class="row" style="margin-top: 20px">
					<div class="col-md-12">
						<div class="google">
							<a href="">
								<img src="<?php echo e(asset('public/upload/btn_playstore.png')); ?>">
							</a>
						</div>
						<div class="apple">
							<a href="">
								<img src="<?php echo e(asset('public/upload/btn_appstore.png')); ?>">
							</a>
						</div>
					</div>
				</div>
...
?>
<?php /**PATH /home/y31xhhiebz36/public_html/recipeking/resources/views/admin/recipe/share.blade.php ENDPATH**/ ?>