               ...
               <div class="card-body">
                  <div class="col-md-12">
                        ...
                        <div class="col-md-8">                           
                            ...
                            <label><b><?php echo e(__('messages.Cateogry')); ?>:-</b></label><?php echo e($data->category_id); ?></br>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/y31xhhiebz36/public_html/recipeking/resources/views/admin/recipe/view.blade.php ENDPATH**/ ?>