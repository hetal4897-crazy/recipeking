                            ...
                            <div class="card-body">
                                ...
                                <form action="<?php echo e(route('update_profile')); ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="name" placeholder="<?php echo e(__('messages.Name')); ?>"
                                               class="form-control" required name="name" value="<?php echo e(Auth::user()->name); ?>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" required id="email" name="email"
                                               placeholder="<?php echo e(__('messages.Email')); ?>" class="form-control"
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\myproject\recipeking\resources\views/admin/updateprofile.blade.php ENDPATH**/ ?>